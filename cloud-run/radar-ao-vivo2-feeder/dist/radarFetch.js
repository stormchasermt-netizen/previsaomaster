 ...
 > ;
{
     ...
     > ;
    {
        ...
        y;
        {
            ...
            r;
            l;
            ` h t t p s : / / s i g m a . c p t e c . i n p e . b r / l o g s / $ { c o d i g o } / 2 0 `;
            ;
            c;
            o;
            n;
            ...
            a;
            {
                ...
                t;
                m;
                / _ ( \ d { 1 2 } ) \ . ( p n g | j p g | j p e g | g i f ) $ /;
                i;
                e;
                x;
                e;
                ...
                s;
                {
                    ...
                    m;
                    e;
                    ` $ { t s 1 2 } $ { l a y e r   = = =   ' p p i v r '   ?   ' - p p i v r '   :   ' ' } . p n g `;
                    ;
                    i;
                    f;
                    ();
        ...
        e;
        {
            ...
            r;
            ();
            ` S i g m a   f e t c h   e r r o r   f o r   $ { s l u g }   /   $ { l a y e r } : `;
            e;
            ;
        }
    }
