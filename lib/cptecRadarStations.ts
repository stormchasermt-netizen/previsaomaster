...
export const CPTEC_RADAR_STATIONS: CptecRadarStation[] = [
  ...
  { id: 'R12807865', slug: 'santarem', name: 'Santarém', lat: -2.424504, lng: -54.7945175, rangeKm: 500, org: 'sipam', server: 's1', product: 'ppi', subtype: 'ppicz', velocityId: 'R12807353', vilId: 'R12802619', waldvogelId: 'R12804646', sipamSlug: 'sbsn', updateIntervalMinutes: 10, updateIntervalOffsetMinutes: 0, bounds: { minLon: -57.0426, minLat: -4.666354, maxLon: -52.546435, maxLat: -0.182654 } },
  { id: 'R12384666', slug: 'guaratiba', name: 'Guaratiba', lat: -22.99324989, lng: -43.58794022, rangeKm: 250, org: 'inea', server: 's1', product: 'ppi', subtype: 'ppicz', velocityId: 'R12387342', vilId: 'R12382174', waldvogelId: 'R12384501', updateIntervalMinutes: 10, updateIntervalOffsetMinutes: 0, bounds: { minLon: -46.05399022, minLat: -25.24309989, maxLon: -41.12189022, maxLat: -20.74339989 } },
  { id: 'R12437381', slug: 'natal', name: 'Natal', lat: -5.90448, lng: -35.25401, rangeKm: 250, org: 'cemaden', server: 's1', product: 'ppi', subtype: 'ppicz', velocityId: 'R12437382', vilId: 'R12432179', waldvogelId: 'R12434496', updateIntervalMinutes: 10, updateIntervalOffsetMinutes: 0, bounds: { minLon: -37.506313324, minLat: -8.141628265, maxLon: -32.989379883, maxLat: -3.65220499 } },
  { id: 'RMT0100DS', funcemeId: 'DWSR92X', slug: 'funceme-quixeramobim', name: 'Quixeramobim', lat: -5.06917, lng: -39.2669, rangeKm: 400, org: 'funceme', server: 's1', product: 'ppi', subtype: 'ppicz', updateIntervalMinutes: 10, updateIntervalOffsetMinutes: 0, bounds: { minLon: -42.8899, minLat: -8.6533, maxLon: -35.6439, maxLat: -1.47747 } },
  { id: 'R12467389', slug: 'salvador', name: 'Salvador', lat: -12.9025, lng: -38.326667, rangeKm: 250, org: 'cemaden', server: 's1', product: 'ppi', subtype: 'ppicz', velocityId: 'R12467390', vilId: 'R12462186', waldvogelId: 'R12464606', updateIntervalMinutes: 10, updateIntervalOffsetMinutes: 0, bounds: { minLon: -40.613765717, minLat: -15.134028435, maxLon: -36.004219055, maxLat: -10.644747734 } },
  { id: 'R12257385', slug: 'maceio', name: 'Maceió', lat: -9.551389, lng: -35.770833, rangeKm: 250, org: 'cemaden', server: 's1', product: 'ppi', subtype: 'ppicz', velocityId: 'R12257386', vilId: 'R12252182', waldvogelId: 'R12254602', updateIntervalMinutes: 10, updateIntervalOffsetMinutes: 0, bounds: { minLon: -38.036766052, minLat: -11.785545349, maxLon: -33.480552673, maxLat: -7.296182156 } },
  { id: 'R12757657', slug: 'boavista', name: 'Boa Vista', lat: 2.8479, lng: -60.695705, rangeKm: 500, org: 'sipam', server: 's1', product: 'ppi', subtype: 'ppicz', velocityId: 'R12757367', vilId: 'R12752569', waldvogelId: 'R12754645', sipamSlug: 'sbbv', updateIntervalMinutes: 10, updateIntervalOffsetMinutes: 0, bounds: { minLon: -62.9452, minLat: 0.60589, maxLon: -58.44621, maxLat: 5.08991 } },
  { id: 'R12827764', slug: 'tabatinga', name: 'Tabatinga', lat: -4.2425575, lng: -69.93045, rangeKm: 500, org: 'sipam', server: 's1', product: 'ppi', subtype: 'ppicz', velocityId: 'R12827361', vilId: 'R12822402', waldvogelId: 'R12824653', sipamSlug: 'sbtt', updateIntervalMinutes: 10, updateIntervalOffsetMinutes: 0, bounds: { minLon: -72.1855, minLat: -6.485105, maxLon: -67.6754, maxLat: -2.00001 } },
  ...
  { id: 'R12787680', slug: 'manaus', name: 'Manaus', lat: -3.143476, lng: -59.986935, rangeKm: 500, org: 'sipam', server: 's1', product: 'ppi', subtype: 'ppicz', velocityId: 'R12787369', vilId: 'R12782570', waldvogelId: 'R12784649', sipamSlug: 'sbmn', updateIntervalMinutes: 10, updateIntervalOffsetMinutes: 0, bounds: { minLon: -62.2375, minLat: -5.385601, maxLon: -57.73637, maxLat: -0.901351 } },
  { id: 'R12767765', slug: 'cruzeirodosul', name: 'Cruzeiro do Sul', lat: -7.5884075, lng: -72.76509, rangeKm: 500, org: 'sipam', server: 's1', product: 'ppi', subtype: 'ppicz', velocityId: 'R12767351', vilId: 'R12762562', waldvogelId: 'R12764648', sipamSlug: 'sbcz', updateIntervalMinutes: 10, updateIntervalOffsetMinutes: 0, bounds: { minLon: -75.0391, minLat: -9.832245, maxLon: -70.49108, maxLat: -5.34457 } },
  ...
  { id: 'R12664593', slug: 'almenara', name: 'Almenara', lat: -16.18919963, lng: -40.647541, rangeKm: 250, org: 'cemaden', server: 's1', product: 'ppi', subtype: 'ppicz', velocityId: 'R12664592', vilId: 'R12662193', waldvogelId: 'R12664618', updateIntervalMinutes: 10, updateIntervalOffsetMinutes: 0, bounds: { minLon: -42.990238, minLat: -18.43678125, maxLon: -38.304844, maxLat: -13.941618 } },
  { id: 'R12837651', slug: 'tefe', name: 'Tefé', lat: -3.3672025, lng: -64.6886875, rangeKm: 500, org: 'sipam', server: 's1', product: 'ppi', subtype: 'ppicz', velocityId: 'R12837365', vilId: 'R12832571', waldvogelId: 'R12834652', sipamSlug: 'sbtf', updateIntervalMinutes: 10, updateIntervalOffsetMinutes: 0, bounds: { minLon: -66.9401, minLat: -5.609415, maxLon: -62.437275, maxLat: -1.12499 } },
  { id: 'R12414596', slug: 'macae', name: 'Macaé', lat: -22.40584946, lng: -41.86047745, rangeKm: 250, org: 'inea', server: 's1', product: 'ppi', subtype: 'ppicz', velocityId: 'R12417343', vilId: 'R12412175', waldvogelId: 'R12414502', updateIntervalMinutes: 10, updateIntervalOffsetMinutes: 0, bounds: { minLon: -44.32652745, minLat: -24.65569946, maxLon: -39.39442745, maxLat: -20.15599946 } },
  { id: 'R12747766', slug: 'belem', name: 'Belém', lat: -1.4019665, lng: -48.45733, rangeKm: 500, org: 'sipam', server: 's1', product: 'ppi', subtype: 'ppicz', velocityId: 'R12747352', vilId: 'R12742572', waldvogelId: 'R12744654', sipamSlug: 'sbbe', updateIntervalMinutes: 10, updateIntervalOffsetMinutes: 0, bounds: { minLon: -50.7025, minLat: -3.643424, maxLon: -46.21216, maxLat: 0.839491 } },
  { id: 'R12427379', slug: 'petrolina', name: 'Petrolina', lat: -9.367, lng: -40.573, rangeKm: 250, org: 'cemaden', server: 's1', product: 'ppi', subtype: 'ppicz', velocityId: 'R12427380', vilId: 'R12422178', waldvogelId: 'R12424495', updateIntervalMinutes: 10, updateIntervalOffsetMinutes: 0, bounds: { minLon: -42.838165283, minLat: -11.60140419, maxLon: -38.28440094, maxLat: -7.11203622 } },
  { id: 'GMWR1000SST', funcemeId: 'GMWR1000SST', slug: 'funceme-fortaleza', name: 'Fortaleza', lat: -3.7944, lng: -38.5575, rangeKm: 480, org: 'funceme', server: 's1', product: 'ppi', subtype: 'ppicz', updateIntervalMinutes: 10, updateIntervalOffsetMinutes: 0, bounds: { minLon: -42.1691, minLat: -7.378549, maxLon: -34.94578, maxLat: -0.205189 } },
  { id: 'R12817768', slug: 'saogabriel', name: 'São Gabriel da Cachoeira', lat: -0.139185, lng: -67.05253, rangeKm: 500, org: 'sipam', server: 's1', product: 'ppi', subtype: 'ppicz', velocityId: 'R12817355', vilId: 'R12812403', waldvogelId: 'R12814651', sipamSlug: 'sbsg', updateIntervalMinutes: 10, updateIntervalOffsetMinutes: 0, bounds: { minLon: -69.2951, minLat: -2.38039, maxLon: -64.80996, maxLat: 2.10202 } },
  ...
  { id: 'R12907662', slug: 'saoluiz', name: 'São Luiz', lat: -2.595277, lng: -44.23476, rangeKm: 500, org: 'sipam', server: 's1', product: 'ppi', subtype: 'ppicz', velocityId: 'R12907371', vilId: 'R12902611', waldvogelId: 'R12904650', sipamSlug: 'sbsl', updateIntervalMinutes: 10, updateIntervalOffsetMinutes: 0, bounds: { minLon: -46.4834, minLat: -4.837192, maxLon: -41.98612, maxLat: -0.353362 } },

  // Radares Especiais (Mosaico custom ou Links Fixos)
  { id: 'R12093557', slug: 'ipmet-bauru', name: 'IPMet Mosaico (PP/Bauru)', lat: -22.116, lng: -51.385, rangeKm: 240, org: 'cemaden', server: 's1', product: 'ppi', subtype: 'ppicz', updateIntervalMinutes: 15, updateIntervalOffsetMinutes: 0 },
