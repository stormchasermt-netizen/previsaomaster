...
export const CPTEC_RADAR_STATIONS: CptecRadarStation[] = [
  ...
  { id: 'R12558322', slug: 'santiago', name: 'Santiago', lat: -29.2045, lng: -54.9406, rangeKm: 250, org: 'decea', server: 's1', product: 'ppi', subtype: 'ppicz', velocityId: 'R12558323', vilId: 'R12558321', waldvogelId: 'R12554487', updateIntervalMinutes: 10, updateIntervalOffsetMinutes: 0, bounds: { minLon: -57.5513, minLat: -31.4619, maxLon: -52.2986, maxLat: -26.956 } },
  { id: 'R12578316', slug: 'cangucu', name: 'Canguçu', lat: -31.3821, lng: -52.7126, rangeKm: 250, org: 'decea', server: 's1', product: 'ppi', subtype: 'ppicz', velocityId: 'R12577538', vilId: 'R12578315', waldvogelId: 'R12574488', updateIntervalMinutes: 10, updateIntervalOffsetMinutes: 0, bounds: { minLon: -55.3873, minLat: -33.6406, maxLon: -50.0057, maxLat: -29.1325 } },
  { id: 'R12137761', slug: 'chapeco', name: 'Chapecó', lat: -27.0335, lng: -52.5986, rangeKm: 250, org: 'sdcsc', server: 's2', product: 'ppi', subtype: 'ppicz', velocityId: 'R12137762', vilId: 'R12132556', waldvogelId: 'R12134629', updateIntervalMinutes: 10, updateIntervalOffsetMinutes: 0, bounds: { minLon: -55.1672, minLat: -29.2854, maxLon: -50.0300, maxLat: -24.7816 } },
  { id: 'R12227759', slug: 'lontras', name: 'Lontras', lat: -27.2147, lng: -49.4559, rangeKm: 250, org: 'sdcsc', server: 's1', product: 'ppi', subtype: 'ppicz', velocityId: 'R12227760', vilId: 'R12222198', waldvogelId: 'R12224626', updateIntervalMinutes: 10, updateIntervalOffsetMinutes: 0, bounds: { minLon: -52.029, minLat: -29.4667, maxLon: -46.8827, maxLat: -24.9627 } },
  ...
  { id: 'R12567564', slug: 'picocouto', name: 'Pico do Couto', lat: -22.4466, lng: -43.2971, rangeKm: 250, org: 'decea', server: 's1', product: 'ppi', subtype: 'ppicz', velocityId: 'R12567537', vilId: 'R12567556', waldvogelId: 'R12564846', updateIntervalMinutes: 10, updateIntervalOffsetMinutes: 0, bounds: { minLon: -45.7583, minLat: -24.701, maxLon: -40.8262, maxLat: -20.2013 } },
  { id: 'R12507565', slug: 'gama', name: 'Gama', lat: -15.9648, lng: -48.0219, rangeKm: 250, org: 'decea', server: 's1', product: 'ppi', subtype: 'ppicz', velocityId: 'R12507562', vilId: 'R12507561', waldvogelId: 'R12504490', updateIntervalMinutes: 10, updateIntervalOffsetMinutes: 0, bounds: { minLon: -50.3701, minLat: -18.2131, maxLon: -45.6527, maxLat: -13.7188 } },

  // INEA - Rio de Janeiro
  { id: 'R12957397', slug: 'guaratiba', name: 'Guaratiba', lat: -22.9932, lng: -43.5879, rangeKm: 250, org: 'inea', server: 's1', product: 'ppi', subtype: 'ppicz', velocityId: 'R12957398', vilId: 'R12952194', waldvogelId: 'R12954620', updateIntervalMinutes: 10, updateIntervalOffsetMinutes: 0, bounds: { minLon: -46.05399, minLat: -25.24309, maxLon: -41.12189, maxLat: -20.74339 } },
  { id: 'R12997399', slug: 'macae', name: 'Macaé', lat: -22.4058, lng: -41.8604, rangeKm: 250, org: 'inea', server: 's1', product: 'ppi', subtype: 'ppicz', velocityId: 'R12997758', vilId: 'R12992196', waldvogelId: 'R12994623', updateIntervalMinutes: 10, updateIntervalOffsetMinutes: 0, bounds: { minLon: -44.32652, minLat: -24.65569, maxLon: -39.39442, maxLat: -20.15599 } },

  // CEMADEN
  { id: 'R12977393', slug: 'santatereza', name: 'Santa Tereza', lat: -19.9728, lng: -40.5452, rangeKm: 250, org: 'cemaden', server: 's1', product: 'ppi', subtype: 'ppicz', velocityId: 'R12977394', vilId: 'R12972190', waldvogelId: 'R12974614', updateIntervalMinutes: 10, updateIntervalOffsetMinutes: 0, bounds: { minLon: -42.93921, minLat: -22.2203, maxLon: -38.15125, maxLat: -17.7253 } },
  { id: 'R12897395', slug: 'almenara', name: 'Almenara', lat: -16.1891, lng: -40.6475, rangeKm: 250, org: 'cemaden', server: 's1', product: 'ppi', subtype: 'ppicz', velocityId: 'R12897396', vilId: 'R12892192', waldvogelId: 'R12894617', updateIntervalMinutes: 10, updateIntervalOffsetMinutes: 0, bounds: { minLon: -42.99023, minLat: -18.43678, maxLon: -38.30484, maxLat: -13.94161 } },
  { id: 'R12457387', slug: 'saofrancisco', name: 'São Francisco', lat: -16.0173, lng: -44.6952, rangeKm: 250, org: 'cemaden', server: 's1', product: 'ppi', subtype: 'ppicz', velocityId: 'R12457388', vilId: 'R12452184', waldvogelId: 'R12454605', updateIntervalMinutes: 10, updateIntervalOffsetMinutes: 0, bounds: { minLon: -47.00994, minLat: -18.23781, maxLon: -42.33536, maxLat: -13.74863 } },
  { id: 'R12477391', slug: 'tresmarias', name: 'Três Marias', lat: -18.2072, lng: -45.4605, rangeKm: 250, org: 'cemaden', server: 's1', product: 'ppi', subtype: 'ppicz', velocityId: 'R12477392', vilId: 'R12472188', waldvogelId: 'R12474611', updateIntervalMinutes: 10, updateIntervalOffsetMinutes: 0, bounds: { minLon: -47.7979, minLat: -20.43413, maxLon: -43.06766, maxLat: -15.94504 } },
  { id: 'R12277383', slug: 'jaraguari', name: 'Jaraguari', lat: -20.2785, lng: -54.4739, rangeKm: 250, org: 'cemaden', server: 's1', product: 'ppi', subtype: 'ppicz', velocityId: 'R12277384', vilId: 'R12272180', waldvogelId: 'R12274497', updateIntervalMinutes: 10, updateIntervalOffsetMinutes: 0, bounds: { minLon: -56.83762, minLat: -22.50373, maxLon: -52.04715, maxLat: -18.01474 } },
  { id: 'R12247379', slug: 'natal', name: 'Natal', lat: -5.9044, lng: -35.2540, rangeKm: 250, org: 'cemaden', server: 's1', product: 'ppi', subtype: 'ppicz', velocityId: 'R12247380', vilId: 'R12242177', waldvogelId: 'R12244491', updateIntervalMinutes: 10, updateIntervalOffsetMinutes: 0, bounds: { minLon: -37.50631, minLat: -8.14162, maxLon: -32.98937, maxLat: -3.6522 } },
  { id: 'R12447385', slug: 'maceio', name: 'Maceió', lat: -9.5513, lng: -35.7708, rangeKm: 250, org: 'cemaden', server: 's1', product: 'ppi', subtype: 'ppicz', velocityId: 'R12447386', vilId: 'R12442182', waldvogelId: 'R12444600', updateIntervalMinutes: 10, updateIntervalOffsetMinutes: 0, bounds: { minLon: -38.03676, minLat: -11.78554, maxLon: -33.48055, maxLat: -7.29618 } },
