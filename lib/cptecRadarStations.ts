...
export interface CptecRadarStation {
  ...
  /** Configuração para buscar na API SIGMA (cappi/vento). */
...
export const CPTEC_RADAR_STATIONS: CptecRadarStation[] = [
  ...
  { id: 'IPMET-PRUDENTE', slug: 'ipmet-prudente', name: 'IPMet (Pres. Prudente)', lat: -22.175000, lng: -51.372778, rangeKm: 450, org: 'ipmet', server: 's1', product: 'ppi', subtype: 'ppicz', updateIntervalMinutes: 15, updateIntervalOffsetMinutes: 0, bounds: { minLat: -26.4, maxLat: -18.08, minLon: -55.876, maxLon: -44.516 }, sigmaConfig: { cappi: 8335 } },
  { id: 'IPMET-BAURU', slug: 'ipmet-bauru', name: 'IPMet (Bauru)', lat: -22.357778, lng: -49.026667, rangeKm: 450, org: 'ipmet', server: 's1', product: 'ppi', subtype: 'ppicz', updateIntervalMinutes: 15, updateIntervalOffsetMinutes: 0, bounds: { minLat: -26.4, maxLat: -18.08, minLon: -55.876, maxLon: -44.516 }, sigmaConfig: { cappi: 8335 } },
  ...
  { id: 'R12537563', slug: 'saoroque', name: 'São Roque', lat: -23.598889, lng: -47.097778, rangeKm: 250, org: 'decea', server: 's1', product: 'ppi', subtype: 'ppicz', velocityId: 'R12537536', vilId: 'R12537542', waldvogelId: 'R12534843', updateIntervalMinutes: 10, updateIntervalOffsetMinutes: 0, bounds: { minLon: -49.6153, minLat: -25.8356, maxLon: -44.6369, maxLat: -21.3348 }, sigmaConfig: { cappi: 4960, vento: 7536 } },
  { id: 'R12567564', slug: 'picocouto', name: 'Pico do Couto', lat: -22.4466503, lng: -43.2971821, rangeKm: 250, org: 'decea', server: 's1', product: 'ppi', subtype: 'ppicz', velocityId: 'R12567537', vilId: 'R12567556', waldvogelId: 'R12564846', updateIntervalMinutes: 10, updateIntervalOffsetMinutes: 0, bounds: { minLon: -45.7583, minLat: -24.701, maxLon: -40.8262, maxLat: -20.2013 }, sigmaConfig: { cappi: 4963, vento: 7537 } },
  { id: 'R12507565', slug: 'gama', name: 'Gama', lat: -15.9648935, lng: -48.021985, rangeKm: 250, org: 'decea', server: 's1', product: 'ppi', subtype: 'ppicz', velocityId: 'R12507562', vilId: 'R12507561', waldvogelId: 'R12504490', updateIntervalMinutes: 10, updateIntervalOffsetMinutes: 0, bounds: { minLon: -50.3701, minLat: -18.2131, maxLon: -45.6527, maxLat: -13.7188 }, sigmaConfig: { cappi: 4961, vento: 7562 } },
