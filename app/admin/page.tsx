...
export default function Admin() {
  ...
  return (
    <div className="space-y-8 pb-20">
      {/* Menu Admin: Editar eventos | Editar rastros — sempre visível */}
      <nav className="flex items-center gap-1 p-2 rounded-lg bg-slate-900/80 border border-slate-700">
        <Link
          href="/admin"
          className="px-4 py-2.5 rounded-md bg-amber-600 text-white font-medium flex items-center gap-2"
        >
          <ShieldAlert className="w-4 h-4" />
          Editar eventos
        </Link>
        <Link
          href="/admin/rastros-tornados"
      ...
      <div className="flex items-center justify-between flex-wrap gap-3">
          ...
          <div className="flex items-center gap-2">
            <Link href="/admin/rastros-tornados" className="px-4 py-2 rounded-md bg-slate-700 hover:bg-slate-600 text-slate-200 flex items-center gap-2 transition-colors">
              <Wind className="w-4 h-4" /> Rastros de Tornados
            </Link>
            <button 
